...
int main() {
  ...
  while (mySpeaker.IsPlaying()) {
    ...
    std::cout << mysounddevice.GetListenerPosition().x << " "
              << mysounddevice.GetListenerPosition().y << " "
              << mysounddevice.GetListenerPosition().z << std::endl;
    ...
    if (growing) {
      mysounddevice.SetListenerPosition(mysounddevice.GetListenerPosition().x +
                                            0.0001,
                                        mysounddevice.GetListenerPosition().y,
