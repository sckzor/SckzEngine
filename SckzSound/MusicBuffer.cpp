...
float MusicBuffer::GetGain() { return gain; }

void MusicBuffer::SetGain(float gain)
{
    this->gain = gain;
...
void MusicBuffer::CreateMusicBuffer(const char * filename)
{
...
void MusicBuffer::DestroyMusicBuffer()
{
